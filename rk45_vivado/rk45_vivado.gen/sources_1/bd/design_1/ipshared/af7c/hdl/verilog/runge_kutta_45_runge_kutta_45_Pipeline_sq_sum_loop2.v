...
module runge_kutta_45_runge_kutta_45_Pipeline_sq_sum_loop2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        r_in_V_1_2_3_reload,
        r_in_V_2_2_3_reload,
        squared_sum_V_4_0_out,
        squared_sum_V_4_0_out_ap_vld,
...
output   ap_idle;
output   ap_ready;
input  [85:0] r_in_V_0_2_3_reload;
input  [85:0] r_in_V_1_2_3_reload;
input  [85:0] r_in_V_2_2_3_reload;
output  [176:0] squared_sum_V_4_0_out;
output   squared_sum_V_4_0_out_ap_vld;
...
reg ap_idle;
reg squared_sum_V_4_0_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln35_fu_93_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        squared_sum_V_4_0_out_ap_vld = 1'b1;
    end else begin
        squared_sum_V_4_0_out_ap_vld = 1'b0;
    end
end
...
assign grp_macply_fu_1913_p_din1 = squared_sum_V_fu_44;
...
assign squared_sum_V_4_0_out = squared_sum_V_fu_44;

assign trunc_ln859_fu_118_p1 = tmp_s_fu_109_p5[84:0];

endmodule //runge_kutta_45_runge_kutta_45_Pipeline_sq_sum_loop2
