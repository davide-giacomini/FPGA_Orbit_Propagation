...
wire  signed [84:0] sext_ln618_fu_146_p1;
wire   [84:0] zext_ln639_fu_192_p1;
...
wire   [84:0] select_ln638_fu_280_p3;
wire  signed [84:0] sext_ln638_fu_302_p1;
wire   [0:0] or_ln638_7_fu_306_p2;
wire   [0:0] or_ln638_8_fu_320_p2;
wire   [84:0] select_ln638_5_fu_312_p3;
wire   [84:0] select_ln623_fu_184_p3;

assign F2_fu_108_p2 = (12'd1075 - zext_ln501_fu_68_p1);

assign add_ln616_fu_120_p2 = ($signed(F2_fu_108_p2) + $signed(12'd4041));
...
assign icmp_ln616_6_fu_256_p2 = (($signed(F2_fu_108_p2) < $signed(12'd55)) ? 1'b1 : 1'b0);

assign icmp_ln616_fu_114_p2 = (($signed(F2_fu_108_p2) > $signed(12'd55)) ? 1'b1 : 1'b0);

assign icmp_ln617_fu_140_p2 = ((F2_fu_108_p2 == 12'd55) ? 1'b1 : 1'b0);

assign icmp_ln620_fu_150_p2 = ((sh_amt_fu_132_p3 < 12'd54) ? 1'b1 : 1'b0);

assign icmp_ln638_fu_156_p2 = ((sh_amt_fu_132_p3 < 12'd85) ? 1'b1 : 1'b0);
...
assign select_ln623_fu_184_p3 = ((tmp_fu_176_p3[0:0] == 1'b1) ? 85'd38685626227668133590597631 : 85'd0);
...
assign select_ln638_fu_280_p3 = ((or_ln638_fu_274_p2[0:0] == 1'b1) ? 85'd0 : shl_ln639_fu_196_p2);
...
assign sub_ln616_fu_126_p2 = (12'd55 - F2_fu_108_p2);
