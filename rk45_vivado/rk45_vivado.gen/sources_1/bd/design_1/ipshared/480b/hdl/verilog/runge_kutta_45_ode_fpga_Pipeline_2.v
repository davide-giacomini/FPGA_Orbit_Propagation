...
output   ap_idle;
output   ap_ready;
input  [84:0] dv_dt_V_0_07;
input  [84:0] dv_dt_V_1_08;
input  [84:0] dv_dt_V_2_09;
input  [5:0] empty;
...
wire   [1:0] empty_74_fu_95_p2;
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_loop_index_t_load;
wire   [84:0] tmp_7_fu_105_p5;
wire   [2:0] loop_index_t_cast_fu_101_p1;
wire   [2:0] add_ptr52_sum_fu_118_p2;
wire   [5:0] add_ptr52_sum_cast1_fu_124_p1;
wire   [5:0] empty_75_fu_128_p2;
reg    ap_done_reg;
...
assign add_ptr52_sum_cast1_fu_124_p1 = add_ptr52_sum_fu_118_p2;

assign add_ptr52_sum_fu_118_p2 = (loop_index_t_cast_fu_101_p1 + 3'd3);
...
assign empty_74_fu_95_p2 = (ap_sig_allocacmp_loop_index_t_load + 2'd1);

assign empty_75_fu_128_p2 = (empty + add_ptr52_sum_cast1_fu_124_p1);
...
assign p_cast_fu_134_p1 = empty_75_fu_128_p2;
