set moduleName runge_kutta_45_Pipeline_VITIS_LOOP_182_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {runge_kutta_45_Pipeline_VITIS_LOOP_182_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ T_BUS int 512 regular {axi_master 1}  }
	{ sext_ln182 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "T_BUS", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "tt","offset": { "type": "dynamic","port_name": "tt","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln182", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln182 sc_in sc_lv 58 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln182", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln182", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln182 { ap_none {  { sext_ln182 in_data 0 58 } } }
