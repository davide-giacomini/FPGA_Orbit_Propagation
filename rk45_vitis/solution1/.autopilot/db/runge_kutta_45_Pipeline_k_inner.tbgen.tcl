...
set C_modelArgMapList {[ 
	{ "Name" : "i_814", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln170", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln170 sc_in sc_lv 5 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln170", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "add_ln170", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln170 { ap_none {  { add_ln170 in_data 0 5 } } }
