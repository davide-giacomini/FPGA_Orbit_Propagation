...
set C_modelArgList {
	...
	{ p_Val2_3_out int 177 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "r_in_V_0_01_reload", "interface" : "wire", "bitwidth" : 86, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "p_Val2_3_out", "interface" : "wire", "bitwidth" : 177, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ p_Val2_3_out sc_out sc_lv 177 signal 3 } 
	{ p_Val2_3_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_Val2_3_out", "direction": "out", "datatype": "sc_lv", "bitwidth":177, "type": "signal", "bundle":{"name": "p_Val2_3_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.squared_sum_V_macply_fu_73", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "macply",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.squared_sum_V_macply_fu_73.mul_85s_85s_170_1_1_U23", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_32_86_1_1_U28", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	p_Val2_3_out { ap_vld {  { p_Val2_3_out out_data 1 177 }  { p_Val2_3_out_ap_vld out_vld 1 1 } } }
}
