set moduleName runge_kutta_45_Pipeline_VITIS_LOOP_177_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {runge_kutta_45_Pipeline_VITIS_LOOP_177_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ X_BUS int 512 regular {axi_master 1}  }
	{ sext_ln177 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "X_BUS", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "yy","offset": { "type": "dynamic","port_name": "yy","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln177", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln177 sc_in sc_lv 58 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln177", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln177", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln177 { ap_none {  { sext_ln177 in_data 0 58 } } }
