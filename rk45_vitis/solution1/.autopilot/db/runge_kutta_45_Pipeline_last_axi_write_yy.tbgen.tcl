...
set C_modelArgList {
	...
	{ sext_ln286 int 60 regular  }
	{ mul399 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "X_BUS", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "yy","offset": { "type": "dynamic","port_name": "yy","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln286", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
 	{ "Name" : "mul399", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln286 sc_in sc_lv 60 signal 1 } 
	{ mul399 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln286", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln286", "role": "default" }} , 
 	{ "name": "mul399", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mul399", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln286 { ap_none {  { sext_ln286 in_data 0 60 } } }
	mul399 { ap_none {  { mul399 in_data 0 32 } } }
