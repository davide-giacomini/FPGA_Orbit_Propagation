set moduleName runge_kutta_45_Pipeline_last_axi_write_yy
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {runge_kutta_45_Pipeline_last_axi_write_yy}
set C_modelType { void 0 }
set C_modelArgList {
	{ X_BUS int 128 regular {axi_master 1}  }
	{ sext_ln254 int 60 regular  }
	{ mul389 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "X_BUS", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "yy","offset": { "type": "dynamic","port_name": "yy","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln254", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
 	{ "Name" : "mul389", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln254 sc_in sc_lv 60 signal 1 } 
	{ mul389 sc_in sc_lv 32 signal 2 } 
	{ yy_loc_V_address0 sc_out sc_lv 15 signal 3 } 
	{ yy_loc_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ yy_loc_V_q0 sc_in sc_lv 85 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln254", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln254", "role": "default" }} , 
 	{ "name": "mul389", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mul389", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln254 { ap_none {  { sext_ln254 in_data 0 60 } } }
	mul389 { ap_none {  { mul389 in_data 0 32 } } }
