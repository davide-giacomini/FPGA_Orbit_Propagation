...
set C_modelArgList {
	...
	{ add413 int 32 regular  }
	{ tt_loc_V int 100 regular {array 2048 { 1 3 } 1 1 }  }
	{ tt int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "T_BUS", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "tt","offset": { "type": "dynamic","port_name": "tt","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "add413", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "tt_loc_V", "interface" : "memory", "bitwidth" : 100, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add413 sc_in sc_lv 32 signal 1 } 
	{ tt_loc_V_address0 sc_out sc_lv 11 signal 2 } 
	{ tt_loc_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ tt_loc_V_q0 sc_in sc_lv 100 signal 2 } 
	{ tt sc_in sc_lv 64 signal 3 } 
	{ zext_ln291 sc_in sc_lv 35 signal 4 } 
	{ trunc_ln5 sc_in sc_lv 6 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add413", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add413", "role": "default" }} , 
 	...
 	{ "name": "tt_loc_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":100, "type": "signal", "bundle":{"name": "tt_loc_V", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	add413 { ap_none {  { add413 in_data 0 32 } } }
	tt_loc_V { ap_memory {  { tt_loc_V_address0 mem_address 1 11 }  { tt_loc_V_ce0 mem_ce 1 1 }  { tt_loc_V_q0 in_data 0 100 } } }
