...
entity runge_kutta_45_runge_kutta_45_Pipeline_sq_sum_loop2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of runge_kutta_45_runge_kutta_45_Pipeline_sq_sum_loop2 is 
...
begin
    mux_32_86_1_1_U136 : component runge_kutta_45_mux_32_86_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 86,
        ...
        dout_WIDTH => 86)
    port map (
        din0 => r_in_V_0_2_3_reload,
        din1 => r_in_V_1_2_3_reload,
        din2 => r_in_V_2_2_3_reload,
        din3 => i_fu_40,
    ...
    squared_sum_V_4_0_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln35_fu_93_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln35_fu_93_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            squared_sum_V_4_0_out_ap_vld <= ap_const_logic_1;
        else 
            squared_sum_V_4_0_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
