...
attribute shreg_extract : string;
    ...
    signal exitcond82_fu_87_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_73_fu_116_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    mux_32_80_1_1_U47 : component runge_kutta_45_mux_32_80_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 80,
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, exitcond82_fu_87_p2, ap_start_int)
    begin
        if (((exitcond82_fu_87_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
    ...
    empty_73_fu_116_p2 <= std_logic_vector(unsigned(empty) + unsigned(loop_index17_t_cast1_fu_99_p1));
    ...
    out_r_we0_assign_proc : process(ap_CS_fsm_state1, exitcond82_fu_87_p2, ap_start_int)
    begin
        if (((exitcond82_fu_87_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
    ...
    p_cast_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_73_fu_116_p2),64));
end behav;
