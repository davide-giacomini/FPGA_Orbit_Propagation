...
set Library     "hls"
set IPName      "runge_kutta_45"
set Version     "1.0"
set DisplayName "Runge_kutta_45"
set Revision    "2113088904"
...
set xo_kernel_name "runge_kutta_45"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/davide/Projects/runge_kutta_45/rk45_vitis/solution1"
set debug_dir "/home/davide/Projects/runge_kutta_45/rk45_vitis/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {runge_kutta_45_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "runge_kutta_45"
set TopNoPrefix "runge_kutta_45"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST R 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST R 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 yy_1 W 0x0 "Data signal of yy" {{0 32 yy W 0 "Bit 31 to 0 of yy"}}} {0x14 yy_2 W 0x0 "Data signal of yy" {{0 32 yy W 0 "Bit 63 to 32 of yy"}}} {0x1c tt_1 W 0x0 "Data signal of tt" {{0 32 tt W 0 "Bit 31 to 0 of tt"}}} {0x20 tt_2 W 0x0 "Data signal of tt" {{0 32 tt W 0 "Bit 63 to 32 of tt"}}} {0x28 tf_1 W 0x0 "Data signal of tf" {{0 32 tf W 0 "Bit 31 to 0 of tf"}}} {0x2c tf_2 W 0x0 "Data signal of tf" {{0 32 tf W 0 "Bit 63 to 32 of tf"}}} {0x34 h0_1 W 0x0 "Data signal of h0" {{0 32 h0 W 0 "Bit 31 to 0 of h0"}}} {0x38 h0_2 W 0x0 "Data signal of h0" {{0 32 h0 W 0 "Bit 63 to 32 of h0"}}} {0x40 atol_1 W 0x0 "Data signal of atol" {{0 32 atol W 0 "Bit 31 to 0 of atol"}}} {0x44 atol_2 W 0x0 "Data signal of atol" {{0 32 atol W 0 "Bit 63 to 32 of atol"}}} {0x4c h_max_1 W 0x0 "Data signal of h_max" {{0 32 h_max W 0 "Bit 31 to 0 of h_max"}}} {0x50 h_max_2 W 0x0 "Data signal of h_max" {{0 32 h_max W 0 "Bit 63 to 32 of h_max"}}} {0x58 h_min_1 W 0x0 "Data signal of h_min" {{0 32 h_min W 0 "Bit 31 to 0 of h_min"}}} {0x5c h_min_2 W 0x0 "Data signal of h_min" {{0 32 h_min W 0 "Bit 63 to 32 of h_min"}}} {0x64 mu_1 W 0x0 "Data signal of mu" {{0 32 mu W 0 "Bit 31 to 0 of mu"}}} {0x68 mu_2 W 0x0 "Data signal of mu" {{0 32 mu W 0 "Bit 63 to 32 of mu"}}} {0x70 size R 0x0 "Data signal of size" {{0 32 size R 0 "Bit 31 to 0 of size"}}} {0x74 size_ctrl R 0x0 "Control signal of size" {{0 1 size_ap_vld R 0 "Control signal size_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 flag R 0x0 "Data signal of flag" {{0 1 flag R 0 "Bit 0 to 0 of flag"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x84 flag_ctrl R 0x0 "Control signal of flag" {{0 1 flag_ap_vld R 0 "Control signal flag_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_X_BUS m_axi_T_BUS"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_X_BUS {
        ...
        handshake ""
        busParams "NUM_READ_OUTSTANDING 1 NUM_WRITE_OUTSTANDING 8 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE READ_WRITE HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "X_BUS"
        ctype {
            AWLEN {
                Type "integer unsigned"
        ...
        data_width "128"
        port_prefix "m_axi_X_BUS"
        param_prefix "C_M_AXI_X_BUS"
    ...
    m_axi_T_BUS {
        ...
        data_width "128"
        port_prefix "m_axi_T_BUS"
        param_prefix "C_M_AXI_T_BUS"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 128 WSTRB 16 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 128 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
