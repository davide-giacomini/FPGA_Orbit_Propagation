...
wire   [5:0] empty_84_fu_563_p2;
reg   [5:0] empty_84_reg_935;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        empty_75_reg_698[13 : 1] <= empty_75_fu_264_p2[13 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state10) & (icmp_ln101_fu_493_p2 == 1'd1))) begin
        empty_84_reg_935[5 : 1] <= empty_84_fu_563_p2[5 : 1];
    end
end
...
assign empty_74_fu_252_p1 = in_offset[12:0];

assign empty_75_fu_264_p2 = (p_shl_fu_244_p3 - p_shl1_fu_256_p3);

assign empty_76_fu_288_p2 = (loop_index29_t_fu_56 + 2'd1);

assign empty_77_fu_294_p2 = (empty_75_reg_698 + loop_index29_t_cast9_fu_278_p1);

assign empty_78_fu_341_p2 = (loop_index26_t_fu_72 + 2'd1);

assign empty_79_fu_357_p2 = (empty_75_reg_698 + add_ptr_sum_cast10_fu_353_p1);

assign empty_80_fu_405_p2 = (loop_index23_t_fu_88 + 2'd1);

assign empty_81_fu_448_p2 = (loop_index20_t_fu_104 + 2'd1);

assign empty_82_fu_541_p1 = out_offset[2:0];

assign empty_83_fu_552_p1 = out_offset[4:0];

assign empty_84_fu_563_p2 = (p_shl4_fu_544_p3 - p_shl5_fu_555_p3);
...
assign p_cast11_fu_362_p1 = empty_79_fu_357_p2;

assign p_cast_fu_299_p1 = empty_77_fu_294_p2;

assign p_shl1_fu_256_p3 = {{empty_74_fu_252_p1}, {1'd0}};

assign p_shl4_fu_544_p3 = {{empty_82_fu_541_p1}, {3'd0}};

assign p_shl5_fu_555_p3 = {{empty_83_fu_552_p1}, {1'd0}};
...
always @ (posedge ap_clk) begin
    empty_75_reg_698[0] <= 1'b0;
    empty_84_reg_935[0] <= 1'b0;
end
