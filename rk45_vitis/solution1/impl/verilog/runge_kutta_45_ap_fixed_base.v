...
wire  signed [99:0] sext_ln618_fu_146_p1;
wire   [99:0] zext_ln639_fu_192_p1;
...
wire   [99:0] select_ln638_fu_280_p3;
wire  signed [99:0] sext_ln638_fu_302_p1;
wire   [0:0] or_ln638_7_fu_306_p2;
wire   [0:0] or_ln638_8_fu_320_p2;
wire   [99:0] select_ln638_5_fu_312_p3;
wire   [99:0] select_ln623_fu_184_p3;
...
assign icmp_ln638_fu_156_p2 = ((sh_amt_fu_132_p3 < 12'd100) ? 1'b1 : 1'b0);
...
assign select_ln623_fu_184_p3 = ((tmp_fu_176_p3[0:0] == 1'b1) ? 100'd1267650600228229401496703205375 : 100'd0);
...
assign select_ln638_fu_280_p3 = ((or_ln638_fu_274_p2[0:0] == 1'b1) ? 100'd0 : shl_ln639_fu_196_p2);
