...
always @ (posedge ap_clk) begin
    if (((i_3_load_fu_124_p1 == 2'd1) & (icmp_ln61_fu_127_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        r_in_V_1_1_fu_54 <= r_in_V_1_4_fu_171_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~(i_3_load_fu_124_p1 == 2'd1) & ~(i_3_load_fu_124_p1 == 2'd0) & (icmp_ln61_fu_127_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        r_in_V_1_2_fu_58 <= r_in_V_1_4_fu_171_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((i_3_load_fu_124_p1 == 2'd0) & (icmp_ln61_fu_127_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln61_fu_127_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln61_fu_133_p2 = (ap_sig_allocacmp_i_3 + 2'd1);
...
assign icmp_ln61_fu_127_p2 = ((ap_sig_allocacmp_i_3 == 2'd3) ? 1'b1 : 1'b0);
