...
attribute shreg_extract : string;
    ...
    signal sext_ln618_fu_146_p1 : STD_LOGIC_VECTOR (99 downto 0);
    signal zext_ln639_fu_192_p1 : STD_LOGIC_VECTOR (99 downto 0);
    ...
    signal shl_ln639_fu_196_p2 : STD_LOGIC_VECTOR (99 downto 0);
    ...
    signal select_ln638_fu_280_p3 : STD_LOGIC_VECTOR (99 downto 0);
    signal sext_ln638_fu_302_p1 : STD_LOGIC_VECTOR (99 downto 0);
    signal or_ln638_7_fu_306_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln638_8_fu_320_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln638_5_fu_312_p3 : STD_LOGIC_VECTOR (99 downto 0);
    signal select_ln623_fu_184_p3 : STD_LOGIC_VECTOR (99 downto 0);
...
begin
    ...
    add_ln616_fu_120_p2 <= std_logic_vector(unsigned(F2_fu_108_p2) + unsigned(ap_const_lv12_FC4));
    ...
    icmp_ln616_6_fu_256_p2 <= "1" when (signed(F2_fu_108_p2) < signed(ap_const_lv12_3C)) else "0";
    icmp_ln616_fu_114_p2 <= "1" when (signed(F2_fu_108_p2) > signed(ap_const_lv12_3C)) else "0";
    icmp_ln617_fu_140_p2 <= "1" when (F2_fu_108_p2 = ap_const_lv12_3C) else "0";
    icmp_ln620_fu_150_p2 <= "1" when (unsigned(sh_amt_fu_132_p3) < unsigned(ap_const_lv12_36)) else "0";
    icmp_ln638_fu_156_p2 <= "1" when (unsigned(sh_amt_fu_132_p3) < unsigned(ap_const_lv12_64)) else "0";
    ireg_fu_42_p1 <= d;
    ...
    select_ln623_fu_184_p3 <= 
        ap_const_lv100_FFFFFFFFFFFFFFFFFFFFFFFFF when (tmp_fu_176_p3(0) = '1') else 
        ap_const_lv100_0;
    ...
    select_ln638_fu_280_p3 <= 
        ap_const_lv100_0 when (or_ln638_fu_274_p2(0) = '1') else 
        shl_ln639_fu_196_p2;
        sext_ln618_fu_146_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(man_V_12_fu_94_p3),100));

        sext_ln621_fu_162_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sh_amt_fu_132_p3),32));

        sext_ln638_fu_302_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(select_ln638_4_fu_294_p3),100));
    ...
    sub_ln616_fu_126_p2 <= std_logic_vector(unsigned(ap_const_lv12_3C) - unsigned(F2_fu_108_p2));
    ...
    zext_ln639_fu_192_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln621_fu_162_p1),100));
end behav;
