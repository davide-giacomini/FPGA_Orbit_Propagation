...
### Anche se adimensionalizzo, ho la posizione iniziale sui 10^-6, sebbene il tempo finale mi è molto più piccolo.
### E comunque quello che conta è la differenza tra i tempi, che comunque è altissima. Comunque la tolleranza mi va a 10^-18
...
t_final, y_final, h_final, tolerance_respected = rk_45(ode_wrapper, t0_adim, tf_adim, np.concatenate((r0_adim, v0_adim)), h_init_adim, tol_adim, h_max_adim, h_min_adim) 
print("Tolerance respected: ", tolerance_respected)
...
write_to_csv(y_final_adim, "y_rk45_tol09_adim_python.csv", constants.dir)
write_to_csv(t_final_adim, "t_rk45_tol09_adim_python.csv", constants.dir)
write_to_csv(h_final_adim, "h_rk45_tol09_adim_python.csv", constants.dir)
#**** Adimensional ends ****#