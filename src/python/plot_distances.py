...
ax.plot(t_rk5_cpp_fpga_simulation[::100], euclidean_distance(rk5_cpp_fpga_simulation[::100, :], utils.kepler_orbit(t_rk5_cpp_fpga_simulation[::100], r0, v0, mu)[:, :]), label="Distance between exact orbit and rk5 in FPGA simulation with tol=1e-09", color="red")
